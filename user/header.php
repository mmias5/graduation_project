...
/* ========= header ========= */
  ...
  .nav-btn{
    ...
    font-weight:800; font-size:15.5px; padding:10px 14px; border-radius:999px; cursor:pointer; white-space:nowrap;
  }
...
.dropdown:focus-within .menu{
  ...
  .user-badge{ display:flex; align-items:center; gap:8px; color:#fff; font-weight:700; padding:4px 8px; border-radius:999px; }
  ...
  .sidebar-header{
    padding:20px; border-bottom:1px solid #eef0f6; display:flex; align-items:center; gap:14px;
    background:linear-gradient(135deg, var(--royal) 0%, var(--lightBlue) 100%); color:#fff;
  }
  .avatar{ width:48px; height:48px; border-radius:50%; border:2px solid #f4df6d; display:grid; place-items:center; background:rgba(255,255,255,.1); }
  .user-name{ font-weight:800; font-size:18px }
  .points{ display:inline-flex; align-items:center; gap:8px; margin-top:4px; background:#fff; color:#111; padding:4px 10px; border-radius:999px; font-weight:700; font-size:13px; border:2px solid var(--sun); box-shadow:0 2px 0 rgba(0,0,0,.06); }

  .sidebar-content{ padding:16px; display:grid; gap:12px }
  .side-btn{ width:100%; display:flex; align-items:center; gap:12px; justify-content:flex-start; padding:12px 14px; border-radius:12px; cursor:pointer; font-weight:700; text-decoration:none; border:2px solid #e7e9f2; background:#fff; color:var(--ink); transition:.15s ease; }
  ...
  .side-btn.primary{ background:linear-gradient(135deg, var(--royal), var(--lightBlue)); border-color:transparent; color:#fff; box-shadow:0 6px 18px rgba(72,113,219,.35); }
  ...
  /* ==== Dropdown link styling (fixed back to blue icons + text) ==== */
  .menu a {
    display:flex;
    align-items:center;
    gap:12px;
    ...
    <nav class="main-nav" aria-label="Primary">
      ...
      <div class="dropdown">
        <button class="nav-btn has-caret" type="button" aria-haspopup="true" aria-expanded="false">
          Clubs
          <svg class="caret" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m6 9 6 6 6-6"/></svg>
        </button>
        <div class="menu" role="menu" aria-label="Clubs menu">
          ...
          <a href="create_club.php" role="menuitem">
            <svg class="icon" width="18" height="18" viewBox="0 0 24 24" fill="none"
                 stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="user-block">
      <div class="user-badge">
        <span class="user-icon" aria-hidden="true">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#f4df6d" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<div class="sidebar-wrap" role="presentation">
  ...
  <aside id="sidebarPanel" class="sidebar" role="dialog" aria-modal="true" aria-labelledby="sideTitle" aria-describedby="sideDesc">
    <div class="sidebar-header">
      <div class="avatar" aria-hidden="true">
        <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#f4df6d" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M20 21a8 8 0 1 0-16 0"></path><circle cx="12" cy="7" r="4"></circle>
        </svg>
      </div>
        ...
        <div style="display:flex; align-items:center; gap:8px;">
          ...
          <a href="editprofile.php"
             style="display:flex; align-items:center; justify-content:center; width:22px; height:22px;
                    border-radius:6px; border:2px solid var(--sun); background:white;
