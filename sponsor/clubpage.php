...
.tag{
  background:var(--gold); color:#2b2f55; font-weight:800;
...
.h-title{
  ...
  text-align:left; color:var(--navy);       /* navy instead of white */
}
.hr{
  height:3px; width:280px; background:var(--gold); opacity:.9; border-radius:3px; margin:10px 0 24px;
}

/* ========= ABOUT CARD ========= */
.about{
  color: var(--navy);
  background: linear-gradient(#e5b758); /* full gold card */
  margin-top:18px;
...
/* ========= LINK TILES ========= */
.link-grid{
  display:grid; grid-template-columns:repeat(3,1fr); gap:20px; max-width:720px; margin-top:10px;
}
.link-tile{
...
.stat h5{margin:0 0 6px; letter-spacing:.25em; text-transform:uppercase; color: var(--navy); font-size:13px}
.kpi{
  background:var(--gold); border:2px solid #e5c94a; border-radius:14px; display:inline-block;
...
<body>
      ...
      <div class="about">
        ...
        <div class="contact-strip">
          ...
          <div>
            ...
            <strong>
              <a href="mailto:president@campusclub.com">
                 president@campusclub.com
              </a>
            </strong>
          </div>
        </div>
        ...
        <!-- LINKS -->
        <h4 style="letter-spacing:.4em; text-transform:uppercase; margin:8px 0 8px; color: var(--navy)">Links</h4>
        <div class="link-grid">
  ...
  <section class="section">
    <div class="wrap">
      ...
      <a href="pastevents.php" class="past-events-btn">📅 View Past Events</a>
